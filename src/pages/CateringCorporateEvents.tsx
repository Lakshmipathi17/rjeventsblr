...
<section className="relative h-[88vh] flex items-center justify-center overflow-hidden">
  ...
  <div className="relative z-10 text-center px-6 max-w-4xl">
    ...
    <p className="text-white/85 text-lg md:text-xl leading-relaxed max-w-2xl mx-auto mb-10">
      From professional buffet setups and live counters to complete catering
      management, RJ Events delivers exceptional food and service for corporate
      meetings, conferences, office celebrations, and large-scale business events.
    </p>
...
export default CateringCorporateEvents;