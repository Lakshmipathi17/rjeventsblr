...
<section className="relative h-[88vh] flex items-center justify-center overflow-hidden">
  ...
  <div className="relative z-10 text-center px-6 max-w-4xl">
    ...
    <p className="text-gold uppercase tracking-[6px] text-xs mb-6">
      RJ Events Baby Shower Catering
    </p>

    {/* Heading */}
    <h1 className="font-heading text-4xl md:text-6xl lg:text-7xl text-white leading-tight mb-6">
      Celebrate Your Beautiful Baby Shower
      <br />
      <span className="text-gold">
        With RJ Events Catering
      </span>
    </h1>

    {/* Description */}
    <p className="text-white/85 text-lg md:text-xl leading-relaxed max-w-2xl mx-auto mb-10">
      Make your baby shower celebration joyful and memorable with delicious
      cuisine, elegant presentation, and warm hospitality from RJ Events.
      We ensure every guest enjoys a delightful dining experience.
    </p>
    ...
    >
      Book Your Baby Shower Catering
    </a>
...
export default CateringBabyShower;