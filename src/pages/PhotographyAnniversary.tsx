...
<section className="relative h-[88vh] flex items-center justify-center overflow-hidden">
  ...
  <div className="relative z-10 text-center px-6 max-w-4xl">
    ...
    <p className="text-white/85 text-lg md:text-xl leading-relaxed max-w-2xl mx-auto mb-10">
      Celebrate your special milestone with professional anniversary photography
      by RJ Events. We capture the emotions, joy, and beautiful moments of your
      celebration to create memories that last forever.
    </p>
    ...
    >
      Book Your Anniversary Photography
    </a>
...
export default PhotographyAnniversary;