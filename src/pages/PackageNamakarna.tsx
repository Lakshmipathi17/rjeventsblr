...
import decor from "@/assets/namakarna-decor.jpg";
import { useState } from "react";


const PackageNamakarna = () => {
...
<section className="relative h-[88vh] flex items-center justify-center overflow-hidden">
  ...
  <img
    src={hero1}
    alt="Namakarna Ceremony Celebration"
  ...
  <div className="relative z-10 text-center px-6 max-w-4xl">
    ...
    <p className="text-white/85 text-lg md:text-xl leading-relaxed max-w-2xl mx-auto mb-10">
      From charming decorations and joyful photography to delicious catering
      and complete event coordination, RJ Events provides everything needed
      to celebrate your baby’s Namakarna ceremony beautifully.
    </p>
  ...
  <div className="container mx-auto px-6">
    ...
    <div className="text-center mb-20">
      <h2 className="font-heading text-4xl md:text-5xl mb-4">
        Complete Namakarna <span className="text-gold">Services</span>
      </h2>

      <p className="text-muted-foreground max-w-2xl mx-auto">
        RJ Events provides everything required to celebrate your baby's
        naming ceremony — from capturing joyful memories to designing
        beautiful decorations and serving delicious food for your guests.
      </p>
    </div>
    ...
    <div className="grid md:grid-cols-3 gap-8">
      ...
      >
        ...
        <div className="absolute bottom-8 left-8 text-white">
          <h3 className="font-heading text-2xl mb-2">
            Namakarna Photography
          </h3>

          <p className="text-white/80 text-sm max-w-[220px]">
            Capturing joyful moments of your baby’s naming ceremony.
          </p>
      ...
      >
        ...
        <div className="absolute bottom-8 left-8 text-white">
          <h3 className="font-heading text-2xl mb-2">
            Namakarna Decoration
          </h3>

          <p className="text-white/80 text-sm max-w-[220px]">
            Creating joyful and charming setups for your celebration.
          </p>
...
export default PackageNamakarna;