...
const PhotographyGruhapravesha = () => {
...
<section className="relative h-[88vh] flex items-center justify-center overflow-hidden">
  ...
  <div className="relative z-10 text-center px-6 max-w-4xl">
    ...
    <p className="text-white/85 text-lg md:text-xl leading-relaxed max-w-2xl mx-auto mb-10">
      Celebrate your new beginning with professional Gruhapravesha photography
      by RJ Events. We capture every joyful moment of your housewarming
      ceremony so you can cherish these memories forever.
    </p>
    ...
    >
      Book Your Gruhapravesha Photography
    </a>
...
export default PhotographyGruhapravesha;