...
const PhotographyCorporateEvents = () => {
  ...
  return (
    <>
      ...
      <div className="bg-background">
        {/* CORPORATE EVENT PHOTOGRAPHY HERO */}
<section className="relative h-[88vh] flex items-center justify-center overflow-hidden">
  ...
  <div className="relative z-10 text-center px-6 max-w-4xl">
    ...
    <p className="text-white/85 text-lg md:text-xl leading-relaxed max-w-2xl mx-auto mb-10">
      Document your conferences, meetings, launches, and corporate celebrations
      with professional photography by RJ Events. We capture every important
      moment to showcase your brand and event success.
    </p>
    ...
    >
      Book Your Corporate Event Photography
    </a>
...
export default PhotographyCorporateEvents;