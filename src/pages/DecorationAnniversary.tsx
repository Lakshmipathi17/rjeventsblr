...
<section className="relative h-[88vh] flex items-center justify-center overflow-hidden">
  ...
  <img
    src={hero1}
    alt="Anniversary Celebration Decoration"
  ...
  <div className="relative z-10 text-center px-6 max-w-4xl">
    ...
    <p className="text-gold uppercase tracking-[6px] text-xs mb-6">
      RJ Events Anniversary Decorations
    </p>
    ...
    <p className="text-white/85 text-lg md:text-xl leading-relaxed max-w-2xl mx-auto mb-10">
      Make your anniversary celebration unforgettable with elegant decorations
      by RJ Events. From romantic stage setups to beautifully styled venues,
      we create the perfect atmosphere to celebrate your journey together.
    </p>
    ...
    >
      Book Your Anniversary Decoration
    </a>
...
export default DecorationAnniversary;