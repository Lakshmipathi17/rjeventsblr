...
<section className="relative h-[88vh] flex items-center justify-center overflow-hidden">
  ...
  <img
    src={hero1}
    alt="Baby Shower Celebration Decoration"
  ...
  <div className="relative z-10 text-center px-6 max-w-4xl">
    ...
    <p className="text-gold uppercase tracking-[6px] text-xs mb-6">
      RJ Events Baby Shower Decorations
    </p>
    ...
    <p className="text-white/85 text-lg md:text-xl leading-relaxed max-w-2xl mx-auto mb-10">
      Welcome the new arrival with beautiful baby shower decorations by RJ Events.
      From elegant balloon themes to charming stage setups and photo corners,
      we create a joyful and memorable celebration for your special day.
    </p>
    ...
    >
      Book Your Baby Shower Decoration
    </a>
...
export default DecorationBabyShower;