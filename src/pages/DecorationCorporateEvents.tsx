...
const DecorationCorporateEvents = () => {
...
<section className="relative h-[88vh] flex items-center justify-center overflow-hidden">
  ...
  <div className="relative z-10 text-center px-6 max-w-4xl">
    ...
    <p className="text-gold uppercase tracking-[6px] text-xs mb-6">
      RJ Events Corporate Decorations
    </p>
    ...
    <p className="text-white/85 text-lg md:text-xl leading-relaxed max-w-2xl mx-auto mb-10">
      Create a lasting impression with elegant corporate event decorations by
      RJ Events. From conferences and product launches to company celebrations
      and award nights, we design professional and stylish event environments.
    </p>
    ...
    >
      Book Your Corporate Event Decoration
    </a>
...
export default DecorationCorporateEvents;