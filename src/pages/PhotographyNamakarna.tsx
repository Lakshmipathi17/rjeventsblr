...
<section className="relative h-[88vh] flex items-center justify-center overflow-hidden">
  ...
  <div className="relative z-10 text-center px-6 max-w-4xl">
    ...
    <p className="text-white/85 text-lg md:text-xl leading-relaxed max-w-2xl mx-auto mb-10">
      Celebrate your baby’s special naming ceremony with professional
      Namakarna photography by RJ Events. We capture the joy, emotions,
      and beautiful moments so you can cherish them forever.
    </p>
    ...
    >
      Book Your Namakarna Photography
    </a>
...
export default PhotographyNamakarna;